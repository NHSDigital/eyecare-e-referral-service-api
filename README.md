...
This is a RESTful HL7® FHIR® API specification for the *Eyecare e-Referrals Service API.
...
Successful deployment of the API Proxy requires:
 ...
 1. A *Target Server* named `eyecare-e-referrals-service-target`
 2. A *Key-Value Map* named `eye-variables`, containing any values you might need at proxy runtime
 3. A *Key-Value Map* named `eye-variables-encrypted`, containing any secrets you might need at proxy runtime
